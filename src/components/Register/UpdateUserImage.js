...
import Profil2 from "../../image/Profil2.png"
        ...
        return (
            <div>
              ...
              <img
               ...
               src={this.props.image.imagePath===null?Profil2:this.props.image.imagePath}
...
export default connect(mapStateToProps, mapDispatchToProps)(UpdateUserImage);
