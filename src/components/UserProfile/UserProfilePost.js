...
class UserProfilePost extends Component {
  ...
  componentDidMount() {
   console.log(this.props.actions.getUserPost(this.props.notification,this.props.currentPostCategory.category?"true":"false")); 
  }
  triggerClick = (postId) => {
  ...
  render() {
    this.props.actions.getUserPost(this.props.notification,this.props.currentPostCategory.category?"true":"false");
...
function mapStateToProps(state) {
  return {
    posts: state.GetUserProfilePostReducer,
...
function mapDispatchToProps(dispatch) {
  return {
    actions: {
      getUserPost:bindActionCreators(UserProfileActions.getPost,dispatch),
...
export default connect(mapStateToProps,mapDispatchToProps)(UserProfilePost)
